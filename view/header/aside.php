<aside class="w-64">
    <div class="overflow-y-auto bg-gray-800 h-screen pt-6">
    ...
    <ul class="space-y-2">
      ...
      <li>
        <a href="../uploadFile/uploadFile.php" class="flex items-center p-2 text-base font-normal text-white hover:bg-gray-700">
