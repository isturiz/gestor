<header class="">
  <nav class="bg-gray-800 border-gray-200 px-4 py-2.5">
    <div class="flex flex-initial justify-between items-center mx-auto max-w-screen-xl">
      <a href="/gestor/view/files/fileList.php  " class="flex items-center">
      ...
      <!-- buscador -->
      <div class="">
        <input type="search" class="px-3 py-1.5 text-base w-96 font-normal text-gray-700 bg-white border border-solid rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" placeholder="Search file" />
      </div>
        ...
        <div class="flex items-center md:order-2">
          ...
          <div class="hidden z-50 my-4 text-base list-none bg-gray-700 rounded divide-y divide-gray-600 shadow" id="user-dropdown" data-popper-reference-hidden="" data-popper-escaped="" data-popper-placement="bottom" style="
            ...
            <ul class="py-1" aria-labelledby="user-menu-button">
              <li>
                <a href="../../controller/system/exit.php" class="block py-2 px-4 text-sm text-gray-200 hover:bg-gray-600 hover:text-white">Others users</a>
              </li>
              <li>
