  ...
  <div class="flex-grow bg-gray-700">
    <main class="container">
      <div class="overflow-x-auto  relative w-full p-8 ">
        ...
        <div id="changeAlert" class="flex p-4 mb-4 rounded-lg bg-blue-200 hidden" role="alert">
          ...
          <button type="button" class="ml-auto -mx-1.5 -my-1.5 rounded-lg focus:ring-2 focus:ring-blue-400 p-1.5  inline-flex h-8 w-8 bg-blue-200 text-blue-600 hover:bg-blue-300" data-dismiss-target="#changeAlert" aria-label="Close" id="changeAlertBtn" onclick="noShowAlert()">
