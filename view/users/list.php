          ...
          <tbody>
            ...
            ?>
              ...
              <tr class="border-b bg-gray-800 border-gray-700 hover:bg-gray-600">
                ...
                <td>
                  <a href="../../controller/users/delete.php?identificationCard=<?php echo $row['cedula'] ?>" data-modal-toggle="editUserModal" class="font-medium text-red-500 hover:underline">eliminar</a>
                </td>
