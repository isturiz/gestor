    ...
    <main class="container">
      <div class="overflow-x-auto  relative w-full p-8 ">
        ...
        <form action="../../controller/users/edit.php" method="POST">
          ...
          <button type="submit" name="edit" class="text-white focus:ring-4 focus:outline-none font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center bg-blue-600 hover:bg-blue-700 focus:ring-blue-800">Edit</button>
        </form>
