<!-- Edit user modal -->
<div id="newUserModal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center p-4 w-full md:inset-0 h-modal md:h-full">
  <div class="relative w-full max-w-2xl h-full md:h-auto">
    ...
    <form action="../../controller/users/register.php" method="POST" class="relative rounded-lg shadow bg-gray-700">
      ...
      <div class="flex justify-between items-start p-4 rounded-t border-b border-gray-600">
        ...
        <button type="button" class="text-gray-400 bg-transparent rounded-lg text-sm p-1.5 ml-auto inline-flex items-center hover:bg-gray-600 hover:text-white" data-modal-toggle="newUserModal">
